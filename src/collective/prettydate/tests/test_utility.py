...
class UtilityTest(unittest.TestCase):
    ...
    def test_long_past_time(self):
        ...
        for i in range(0, 10):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'now')
        ...
        for i in range(10, 60):
            now = DateTime()
            result = self.utility.date(now - (self.second * i))
            self.failUnlessEqual(self.portal.translate(result), u'%s seconds ago' % i)

        # From 1 minute and up to 2 minutes, we get "a minute ago"
        now = DateTime()
        result = self.utility.date(now - (self.minute))
        self.failUnlessEqual(self.portal.translate(result), u'a minute ago')
        ...
        for i in range(2, 60):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'%s minutes ago' % i)

        # From 1 hour and up to 2 hours, we get "an hour ago"
        now = DateTime()
        result = self.utility.date(now - (self.hour))
        self.failUnlessEqual(self.portal.translate(result), u'an hour ago')
    ...
    def test_long_past_date(self):
        ...
        for i in range(2, 5):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'%s weeks ago' % i)

        #Let's check for last month
        now = DateTime()
        result = self.utility.date(now - (self.month))
        self.failUnlessEqual(self.portal.translate(result), u'last month')
        now = DateTime()
        ...
        for i in range(2, 12):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'%s months ago' % i)

        #Let's check for last year
        now = DateTime()
        result = self.utility.date(now - (self.year))
        self.failUnlessEqual(self.portal.translate(result), u'last year')
        now = DateTime()
        ...
        for i in range(2, 20):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'%s years ago' % i)
    ...
    def test_long_future_time(self):
        ...
        for i in range(11, 60):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'in %s seconds' % i)

        # From 1 minute and up to 2 minutes, we get "in a minute"
        now = DateTime()
        result = self.utility.date(now + (self.minute + self.second))
        self.failUnlessEqual(self.portal.translate(result), u'in a minute')
        result = self.utility.date(now + (self.minute * 2 - self.second))
        self.failUnlessEqual(self.portal.translate(result), u'in a minute')
        ...
        for i in range(2, 60):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'in %s minutes' % i)

        # From 1 hour and up to 2 hours, we get "in an hour"
        now = DateTime()
        result = self.utility.date(now + (self.hour + self.second))
        self.failUnlessEqual(self.portal.translate(result), u'in an hour')
        result = self.utility.date(now + (self.hour * 2 - self.second))
        self.failUnlessEqual(self.portal.translate(result), u'in an hour')
    ...
    def test_long_future_date(self):
        ...
        for i in range(2, 5):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'in %s weeks' % i)

        #Let's check for next month
        now = DateTime()
        result = self.utility.date(now + (self.month + self.second))
        self.failUnlessEqual(self.portal.translate(result), u'next month')
        now = DateTime()
        ...
        for i in range(2, 12):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'in %s months' % i)

        #Let's check for next year
        now = DateTime()
        result = self.utility.date(now + (self.year + self.second))
        self.failUnlessEqual(self.portal.translate(result), u'next year')
        now = DateTime()
        result = self.utility.date(now + (self.year * 2 - self.second))
        self.failUnlessEqual(self.portal.translate(result), u'next year')
        ...
        for i in range(2, 20):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'in %s years' % i)
    ...
    def test_short_past_date(self):
        ...
        for i in range(1, 20):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'%sy ago' % i)
    ...
    def test_short_future_time(self):
        ...
        for i in range(11, 60):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'in %ss' % i)
        ...
        for i in range(1, 60):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'in %sm' % i)
    ...
    def test_short_future_date(self):
        ...
        for i in range(1, 12):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'in %smo' % i)
        ...
        for i in range(1, 20):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'in %sy' % i)
    ...
    def test_asdays(self):
        ...
        for i in range(0, 60):
            ...
            self.failUnlessEqual(self.portal.translate(result), u'today')
